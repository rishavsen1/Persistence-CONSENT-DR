...
\pdfinfo{
/Title (P-CONSENT: Committed Demand Response Backed by a Persistent, Negotiated Electric-Vehicle Fleet)
/Author ()
}
...
\newcommand{\etarget}[2]{E^{\mathrm{tgt}}(#1,#2)}     % per-session terminal banking target of user #1, session #2 (kWh)
...
\definecolor{algoblue}{RGB}{20,60,150}
\newcommand{\algocmt}[1]{\footnotesize\textcolor{algoblue}{#1}}

\title{P-CONSENT: Negotiating a Persistent EV Fleet into Day-Ahead Demand-Response Commitments}
